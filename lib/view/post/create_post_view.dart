...
import 'package:mangxahoi/constant/app_colors.dart';
import 'package:mangxahoi/model/model_user.dart';
import 'package:mangxahoi/viewmodel/post_view_model.dart'; // <--- DÒNG NÀY ĐÃ ĐƯỢC SỬA LẠI
import 'package:mangxahoi/notification/notification_service.dart';
...
class _CreatePostViewContentState extends State<_CreatePostViewContent> {
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            // Widget chọn quyền riêng tư được thiết kế lại
                            InkWell(
  ...
  // Hiển thị bottom sheet để chọn quyền riêng tư
