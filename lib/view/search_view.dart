...
//                               // ViewModel sẽ tự động dọn dẹp kết quả khi text trống
//                             },
//                           )
//                         : null,
...
//         toolbarHeight: 70,
//       ),
//       // ===> BODY HIỂN THỊ KẾT QUẢ KHI CÓ QUERY <===
//       body: _buildBody(vm),
//     );
//   }
...
//     // Nếu đang loading (chủ yếu là tải cache user ban đầu)
//     if (vm.isLoading) {
//       return const Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(AppColors.primary)));
//     }

//     // 1. Nếu thanh tìm kiếm trống, hiển thị thông báo mặc định
//     if (!hasQuery) {
//       return Center(
//         child: Text(
...
//     // 2. Hiển thị LỖI/KHÔNG KẾT QUẢ
//     if (vm.errorMessage != null && vm.searchResults.isEmpty) {
//       return Center(child: Text(vm.errorMessage!));
//     }
    
//     // 3. Hiển thị KẾT QUẢ TÌM KIẾM (tìm kiếm gần đúng)
//     return ListView.builder(
//       padding: const EdgeInsets.only(top: 8.0),
//       itemCount: vm.searchResults.length,
//       itemBuilder: (context, index) {
//         final user = vm.searchResults[index];
//         return _buildUserResultTile(context, user);
//       },
//     );
//   }

//   Widget _buildUserResultTile(BuildContext context, UserModel user) {
//     return ListTile(
...
//             SnackBar(content: Text('Đã gửi lời mời kết bạn đến ${user.name}')),
//           );
//         },
...
//       ),
//       onTap: () {
//         // Hành động khi nhấn vào kết quả
//       },
//     );
//   }
// }
// File: lib/view/search_view.dart
...
class _SearchViewContent extends StatelessWidget {
  ...
  Widget _buildUserResultTile(
    ...
    return ListTile(
      ...
      onTap: () {
        // Chuyển hướng đến trang Hồ sơ của người đó
      },
    );
  }
}