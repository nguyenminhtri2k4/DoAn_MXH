...
class _StoryViewerScreenState extends State<StoryViewerScreen> with TickerProviderStateMixin {
    ...
    return GestureDetector(
      ...
      child: Stack(
        ...
        children: [
          ...
          // 3. ✅ THANH TIẾN TRÌNH PHÂN ĐOẠN (MỚI)
  ...
  // ✅ THANH TIẾN TRÌNH PHÂN ĐOẠN (GIỐNG FACEBOOK/INSTAGRAM)
  Widget _buildSegmentedProgressBar() {
    return Positioned(
      top: MediaQuery.of(context).padding.top + 8,
      left: 8,
      right: 60, // Để chừa chỗ cho nút đóng
      child: Row(
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    if (index < _currentIndex) {
                      // Story đã xem - đầy 100%
                      progress = 1.0;
                    } else if (index == _currentIndex) {
                      // Story đang xem - theo animation
  ...
  Widget _buildStoryOverlay(StoryModel story, UserModel? author) {
    return Positioned(
      top: MediaQuery.of(context).padding.top + 20, // Dưới thanh progress
      left: 16,
      right: 16,
      child: Row(
        children: [
