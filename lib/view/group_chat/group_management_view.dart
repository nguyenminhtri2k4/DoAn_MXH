...
class _GroupManagementContent extends StatelessWidget {
  ...
  void _showMemberOptionsSheet(
    ...
    final canTransfer = vm.canTransferOwnership(member.id);
                    ...
                    _buildOptionTile(
                      ...
                      subtitle:
                          isManager
                              ...
                              : 'Cần cấp quyền quản lý trước',
                      onTap: () {
                        Navigator.pop(context);
                        if (isManager) {
                          _confirmTransferOwnership(context, vm, member);
                        } else {
                          _showMustPromoteFirstDialog(context, vm, member);
                        }
                      },
                    ),
  ...
  void _showMustPromoteFirstDialog(
    BuildContext context,
    GroupManagementViewModel vm,
    UserModel member,
  ) {
          ...
          (context) => Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text(
                  'Bạn cần cấp quyền quản lý cho ${member.name} trước khi chuyển quyền chủ nhóm.',
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Đã cấp quyền quản lý cho ${member.name}',
                              ),
                              backgroundColor: Colors.green,
                              duration: const Duration(seconds: 2),
                            ),
                                ...
                                child: Column(
                                  children: [
                                    CircleAvatar(
                                      radius: 28,
                                      backgroundImage:
                                          vm.currentUser?.avatar.isNotEmpty ==
                                                  true
                                              ? NetworkImage(
                                                vm.currentUser!.avatar.first,
                                              )
                                              : null,
                                      child:
                                          vm.currentUser?.avatar.isEmpty ?? true
                                              ? const Icon(Icons.person)
                                              : null,
                                    ),
                                    const SizedBox(height: 8),
                                    Text(
                                      vm.currentUser?.name ?? 'Bạn',
                                      style: const TextStyle(
                                        fontSize: 13,
                                        fontWeight: FontWeight.w600,
                                      ),
                                    ...
                                    Stack(
                                      children: [
                                        CircleAvatar(
                                          radius: 28,
                                          backgroundImage:
                                              newOwner.avatar.isNotEmpty
                                                  ? NetworkImage(
                                                    newOwner.avatar.first,
                                                  )
                                                  : null,
                                          child:
                                              newOwner.avatar.isEmpty
                                                  ? const Icon(Icons.person)
                                                  : null,
                                        ),
                                        Positioned(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 12),
                              _buildWarningItem('Bạn sẽ mất quyền chủ nhóm'),
                              _buildWarningItem('Không thể tự lấy lại quyền'),
                              _buildWarningItem('Có thể bị kick bởi chủ mới'),
                            ],
                          ),
                        ),
                        const SizedBox(height: 20),
                                    ...
                                    agreedToTerms
                                        ? () async {
                                          ...
                                          try {
                                            ...
                                            if (!isTargetManager) {
                                              print(
                                                '🔄 Tự động cấp quyền Manager cho ${newOwner.name}...',
                                              );
                                              await vm.promoteToManager(
                                                newOwner.id,
                                              );
                                              await Future.delayed(
                                                const Duration(
                                            ...
                                            scaffoldMessenger.showSnackBar(
                                              SnackBar(
                                                content: Text(
                                                  '✅ Đã chuyển quyền chủ nhóm cho ${newOwner.name}',
                                                ),
                                                backgroundColor: Colors.green,
