...
class PostStats extends StatelessWidget {
  ...
  const PostStats({super.key, required this.postId, this.postAuthorId});
  ...
  void _openLikeList(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => LikeListView(postId: postId)),
    );
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DocumentSnapshot>(
      stream:
          FirebaseFirestore.instance.collection('Post').doc(postId).snapshots(),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Stack(
                          children:
                              List.generate(topReactions.length.clamp(0, 3), (
                                index,
                              ) {
                                ...
                                return Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: reaction_helper.getReactionIcon(
                                      reactionType,
                                    ),
                                  ),
                                );
