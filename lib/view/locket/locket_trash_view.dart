// // lib/view/locket/locket_trash_view.dart
...
//     try {
//       await _locketRequest.deleteLocketPhotoPermanently(photoId);
//       // StreamBuilder sẽ tự cập nhật
//     } catch (e) {
...
//                             Text(
//                               'Đã xóa: ${timeago.format(photo.deletedAt!.toDate(), locale: 'vi')}',
...
//                                     _showPermanentDeleteConfirmation(context, viewModel, photo.id);
//                                   },
//                                 ),
//                               ],
//                             ),
...
//   void _showPermanentDeleteConfirmation(BuildContext context, LocketTrashViewModel viewModel, String photoId) {
//     showDialog(
//       context: context,
...
//                 await viewModel.deletePermanently(photoId);
//                  if (context.mounted) {
//                       ScaffoldMessenger.of(context).showSnackBar(
